...
#define I2CREG_PE_ADC_ID	 0x000D 	// Len = 1
#define I2CREG_CUST_INFO_ID	 0x000E 	// Len = 1
...
#define I2CREG_PWD	 0x0022 	// Len = 1
...
#define I2CREG_SYS_ERR_LATCH	 0x002C 	// Len = 4
	...
	/*0x0: No error0x1: Section header error0x2: Section CRC failed0x3: Reserved*/
	#define BIT_FTP_CUST_INFO_ERR	18
...
#define I2CREG_DTS_SEND	 0x0038 	// Len = 2
	#define BIT_DTS_ADC_SEND_LEN	0
	#define BIT_DTS_ADC_SEND_REQUEST	8
...
#define I2CREG_DTS_RCVD	 0x003A 	// Len = 2
	#define BIT_DTS_ADC_RCVD_LEN	0
	#define BIT_DTS_ADC_RCVD_REQUEST	8
	/*0x00: ADC/end0x02: ADC/auth0x05: ADC/rst0x10: ADC/prop0x11: ADC/prop0x12: ADC/prop0x13: ADC/prop0x14: ADC/prop0x15: ADC/prop0x16: ADC/prop0x17: ADC/prop0x18: ADC/prop0x19: ADC/prop0x1a: ADC/prop0x1b: ADC/prop0x1c: ADC/prop0x1d: ADC/prop0x1e: ADC/prop0x1f: ADC/prop.*/
#define I2CREG_OP_FREQ	 0x003E 	// Len = 2
#define I2CREG_MEAS_S32	 0x0040 	// Len = 4
	#define BIT_MEAS_ICUR	0
#define I2CREG_MEAS_S16	 0x0044 	// Len = 10
	#define BIT_MEAS_VRECT	0
	#define BIT_MEAS_VOUT	16
	#define BIT_MEAS_TVOUT	32
	#define BIT_MEAS_ADC_IN	48
	#define BIT_MEAS_NTC	64
#define I2CREG_RX_RCVD_PWR	 0x0054 	// Len = 4
#define I2CREG_TX_TFRD_PWR	 0x0058 	// Len = 2
#define I2CREG_LAST_RP	 0x005A 	// Len = 2
#define I2CREG_LAST_CE	 0x005C 	// Len = 2
#define I2CREG_SIGNAL_STRENGTH	 0x005E 	// Len = 1
#define I2CREG_FOD_PARAM_U16	 0x0060 	// Len = 16
	#define BIT_FOD_CUR_THRES1_10MA	0
	#define BIT_FOD_CUR_THRES2_10MA	16
	#define BIT_FOD_CUR_THRES3_10MA	32
	#define BIT_FOD_CUR_THRES4_10MA	48
	#define BIT_FOD_CUR_THRES5_10MA	64
	#define BIT_FOD_CUR_THRES6_10MA	80
	#define BIT_FOD_CUR_THRES7_10MA	96
	#define BIT_FOD_CUR_THRES8_10MA	112
#define I2CREG_FOD_PARAM_S8	 0x0070 	// Len = 9
	...
	#define BIT_FOD_OFFSET6	48
	#define BIT_FOD_OFFSET7	56
	#define BIT_FOD_OFFSET8	64
#define I2CREG_FOD_PARAM_U8	 0x0079 	// Len = 1
	#define BIT_RSER_4MOHM	0
#define I2CREG_FOD_PARAM_S8_END	 0x007A 	// Len = 1
	#define BIT_FOD_GAIN_OFFSET	0
#define I2CREG_PTC	 0x007B 	// Len = 7
	#define BIT_MINOR_VER	0
...
#define I2CREG_RX_INTR_LATCH	 0x0090 	// Len = 4
	...
	/*0x0: Did not occur0x1: Occurred.*/
	#define BIT_RX_UVLO_INTR_LATCH	4
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_TX_REMOVAL_LATCH	12
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_PWRTFR_RP24_NACK_LATCH	13
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_RX_NTC_ADC_INTR_LATCH	15
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_DTS_SEND_SUCCESS_INTR_LATCH	16
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_DTS_SEND_END_TIMEOUT_INTR_LATCH	17
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_DTS_RCVD_SUCCESS_INTR_LATCH	18
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_DTS_RCVD_END_TIMEOUT_INTR_LATCH	19
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_EXT5V_FAULT_INTR_LATCH	20
	/*0x0: Did not occur0x1: Occured*/
	#define BIT_RX_EXT5V_DISCONNECTED_INTR_LATCH	21
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
#define I2CREG_RX_INTR_CLR	 0x0094 	// Len = 4
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_TX_REMOVAL_CLR	12
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_PWRTFR_RP24_NACK_CLR	13
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_RX_NTC_ADC_INTR_CLR	15
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_DTS_SEND_SUCCESS_INTR_CLR	16
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_DTS_SEND_END_TIMEOUT_INTR_CLR	17
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_DTS_RCVD_SUCCESS_INTR_CLR	18
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_DTS_RCVD_END_TIMEOUT_INTR_CLR	19
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_EXT5V_FAULT_INTR_CLR	20
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_EXT5V_DISCONNECTED_INTR_CLR	21
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
#define I2CREG_RX_INTR_EN	 0x0098 	// Len = 4
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_TX_REMOVAL_EN	12
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_PWRTFR_RP24_NACK_EN	13
	/*Received NACK for normal mode RP24 during power transfer.0: Disable1: Enable*/
	#define BIT_RX_NTC_ADC_INTR_EN	15
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_DTS_SEND_SUCCESS_INTR_EN	16
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_DTS_SEND_END_TIMEOUT_INTR_EN	17
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_DTS_RCVD_SUCCESS_INTR_EN	18
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_DTS_RCVD_END_TIMEOUT_INTR_EN	19
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_EXT5V_FAULT_INTR_EN	20
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_EXT5V_DISCONNECTED_INTR_EN	21
...
#define I2CREG_RX_STAT	 0x009C 	// Len = 4
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_TX_REMOVAL_STAT	12
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_PWRTFR_RP24_NACK_STAT	13
	/*Live status of corresponding interrupt*/
	#define BIT_RX_NTC_ADC_INTR_STAT	15
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_DTS_SEND_SUCCESS_STAT	16
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_DTS_SEND_END_TIMEOUT_STAT	17
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_DTS_RCVD_SUCCESS_STAT	18
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_DTS_RCVD_END_TIMEOUT_STAT	19
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_EXT5V_FAULT_INTR_STAT	20
	/*0x0: Is not occuring0x1: Occuring*/
	#define BIT_RX_EXT5V_DISCONNECTED_INTR_STAT	21
	/*Jun Yi LEE:[RX]Live status of corresponding interrupt*/
#define I2CREG_RX_CMD	 0x00A0 	// Len = 2
	...
	/*0x0: Do nothing0x1: Perform action*/
	#define BIT_RX_EXT5V_ON	8
	/*0x0: Do nothing0x1: Perform command*/
	#define BIT_RX_EXT5V_OFF	9
	/*0x0: Do nothing0x1: Perform command*/
#define I2CREG_RX_LDO_CUR_THRES	 0x00A2 	// Len = 3
	#define BIT_RX_LDO_CUR_THRES1_10MA	0
	#define BIT_RX_LDO_CUR_THRES2_10MA	8
	#define BIT_RX_LDO_CUR_THRES3_10MA	16
#define I2CREG_RX_LDO_DROP	 0x00A5 	// Len = 4
	#define BIT_RX_LDO_DROP0	0
	#define BIT_RX_LDO_DROP1	8
	#define BIT_RX_LDO_DROP2	16
	#define BIT_RX_LDO_DROP3	24
#define I2CREG_RX_EPT_MSG	 0x00A9 	// Len = 1
#define I2CREG_RX_VOUT_SET	 0x00AA 	// Len = 2
#define I2CREG_RX_ILIM_SET	 0x00B2 	// Len = 1
#define I2CREG_RX_ARC_AUTO_OFF_THRES	 0x00B3 	// Len = 1
#define I2CREG_TX_INTR_LATCH	 0x00C0 	// Len = 4
	...
	#define BIT_TX_DTS_SEND_SUCCESS_INTR_LATCH	19
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_INTR_LATCH	20
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_TX_DTS_SEND_END_RESET_INTR_LATCH	21
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_TX_DTS_RCVD_SUCCESS_INTR_LATCH	22
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_INTR_LATCH	23
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
	#define BIT_TX_DTS_RCVD_END_RESET_INTR_LATCH	24
	/*Interrupt pending latch status0: No pending interrupt1: Pending interruptSee xxx_intr_clr register for details.*/
#define I2CREG_TX_INTR_CLR	 0x00C4 	// Len = 4
	...
	#define BIT_TX_DTS_SEND_SUCCESS_INTR_CLR	19
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_INTR_CLR	20
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_TX_DTS_SEND_END_RESET_INTR_CLR	21
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_TX_DTS_RCVD_SUCCESS_INTR_CLR	22
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_INTR_CLR	23
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
	#define BIT_TX_DTS_RCVD_END_RESET_INTR_CLR	24
	/*Write 1 to clear corresponding interrupt latch (xxx_intr_latch)*/
#define I2CREG_TX_INTR_EN	 0x00C8 	// Len = 4
...
#define I2CREG_TX_STAT	 0x00CC 	// Len = 4
	...
	#define BIT_TX_DTS_SEND_SUCCESS_STAT	19
	/*Live status of corresponding interrupt*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_STAT	20
	/*Live status of corresponding interrupt*/
	#define BIT_TX_DTS_SEND_END_RESET_STAT	21
	/*Live status of corresponding interrupt*/
	#define BIT_TX_DTS_RCVD_SUCCESS_STAT	22
	/*Live status of corresponding interrupt*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_STAT	23
	/*Live status of corresponding interrupt*/
	#define BIT_TX_DTS_RCVD_END_RESET_STAT	24
	/*Live status of corresponding interrupt*/
...
#define I2CREG_TX_RP_TO_MAX_CNT	 0x00E3 	// Len = 1
#define I2CREG_TX_FHOP_STEP	 0x00E4 	// Len = 1
#define I2CREG_TX_PID_MAX_CUR	 0x00E5 	// Len = 1
#define I2CREG_TX_BRDG_MODE_CUR_THRES	 0x00E6 	// Len = 1
#define I2CREG_TX_EPT_REASON_RCVD	 0x00E7 	// Len = 3
...
#define I2CREG_TX_OP_DC	 0x00EA 	// Len = 1
#define I2CREG_TX_CTRL	 0x00EB 	// Len = 1
...
#define I2CREG_Q_EXCITATION_PERIOD	 0x00EC 	// Len = 2
#define I2CREG_Q_MEAS_RESONANT_FREQ	 0x00EE 	// Len = 2
#define I2CREG_Q_MEAS_QFACTOR	 0x00F0 	// Len = 2
#define I2CREG_Q_MEAS_ADC	 0x00F2 	// Len = 2
