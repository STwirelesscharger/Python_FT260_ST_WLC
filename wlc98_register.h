...
#define I2CREG_FTP_PATCH_ID	 0x0006 	// Len = 2
...
#define I2CREG_SYS_CMD	 0x0020 	// Len = 2
...
#define I2CREG_RX_INTR_EN	 0x0080 	// Len = 4
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_EXT5V_TX_REMOVAL_EN	4
	/*0x0: Disabled0x1: Enabled*/
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_SCP_INTR_EN	12
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_VOUT_LOW_EN	13
	/*0x0: Disabled0x1: Enabled*/
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_RX_AUTH_END_INTR_EN	23
	/*0x0: Disabled0x1: Enabled*/
#define I2CREG_RX_INTR_CLR	 0x0084 	// Len = 4
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_EXT5V_TX_REMOVAL_CLR	4
	/*0x0: No change0x1: Will be cleared*/
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_SCP_INTR_CLR	12
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_VOUT_LOW_CLR	13
	/*0x0: No change0x1: Will be cleared*/
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_RX_AUTH_END_INTR_CLR	23
	/*0x0: No change0x1: Will be cleared*/
#define I2CREG_RX_INTR_LATCH	 0x0088 	// Len = 4
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_EXT5V_TX_REMOVAL_LATCH	4
	/*0x0: Did not occur0x1: Occurred*/
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_SCP_INTR_LATCH	12
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_VOUT_LOW_LATCH	13
	/*0x0: Did not occur0x1: Occurred*/
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_RX_AUTH_END_INTR_LATCH	23
	/*0x0: Did not occur0x1: Occurred*/
#define I2CREG_RX_STAT	 0x008C 	// Len = 4
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_EXT5V_TX_REMOVAL_STAT	4
	/*0x0: Is not occuring0x1: Occurring*/
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_SEND_PKT_SUCCESS_INTR_STAT	8
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_SEND_PKT_TIMEOUT_INTR_STAT	9
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_SIG_STR_STAT	10
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_VRECT_RDY_STAT	11
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_SCP_STAT	12
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_VOUT_LOW_STAT	13
	/*0x0: Is not occuring0x1: Occurring*/
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_RX_AUTH_END_STAT	23
	/*0x0: Is not occuring0x1: Occurring*/
...
#define I2CREG_RX_IIN	 0x0096 	// Len = 2
#define I2CREG_RX_CHIP_TEMP	 0x0098 	// Len = 2
#define I2CREG_RX_OP_FREQ	 0x009A 	// Len = 2
#define I2CREG_RX_NTC	 0x009C 	// Len = 2
#define I2CREG_RX_ADC_IN	 0x00A2 	// Len = 2
	#define BIT_RX_ADC_IN3	0
#define I2CREG_RX_RCVD_PWR	 0x00A4 	// Len = 2
#define I2CREG_QI_RP_VALUE	 0x00A6 	// Len = 2
	#define BIT_RX_RP_VALUE	0
#define I2CREG_RX_CTRL_ERR	 0x00A8 	// Len = 2
#define I2CREG_QI_CE_VALUE	 0x00AA 	// Len = 1
	#define BIT_RX_CE_VALUE	0
#define I2CREG_RX_SIGNAL_STRENGTH	 0x00AB 	// Len = 1
#define I2CREG_RX_PTC	 0x00AC 	// Len = 7
	#define BIT_RX_GUA_PWR	0
	#define BIT_RX_FSK_DEPTH	6
	/*0x0: -282~-249 / 30.25~63.250x1: -157~-124 / 61.5~94.50x2: -94.5~-61.5 / 124~1570x3: -63.25~-30.25 / 249~282*/
	#define BIT_RX_RPR_HDR	8
	/*0x31: RP24 format0x04: RP8 format*/
	#define BIT_RX_PCH	16
	#define BIT_RX_REF_PWR	24
	#define BIT_RX_OB	30
	/*0x0: not supported0x1: supported*/
	#define BIT_RX_AI	31
	/*0x0: not supported0x1: supported*/
	#define BIT_RX_REPING_DELAY	32
	#define BIT_RX_FSK_POLARITY	38
	/*0x0: Positive0x1: Negative*/
	#define BIT_RX_NEG	39
	/*0x0: BPP0x1: EPP*/
	#define BIT_RX_WIN_OFFSET	40
	#define BIT_RX_WIN_SZ	43
	#define BIT_RX_DUP	48
	/*0x0: not supported0x1: supported*/
	#define BIT_RX_BUFF_SIZE	49
	/*0x0: 16 bytes0x1: 32 bytes0x2: 64 bytes0x3: 128 bytes0x4: 256 bytes0x5: 512 bytes0x6: 1024 bytes0x7: 2048 bytes*/
	#define BIT_RX_MINOR_VER	52
#define I2CREG_RX_ILIM_SET	 0x00B3 	// Len = 1
#define I2CREG_RX_VOUT_SET	 0x00B4 	// Len = 2
#define I2CREG_RX_FOD_CUR_THRES	 0x00B6 	// Len = 5
	#define BIT_RX_FOD_CUR_THRES1	0
	#define BIT_RX_FOD_CUR_THRES2	8
	#define BIT_RX_FOD_CUR_THRES3	16
	#define BIT_RX_FOD_CUR_THRES4	24
	#define BIT_RX_FOD_CUR_THRES5	32
#define I2CREG_RX_FOD_GAIN	 0x00BB 	// Len = 6
	#define BIT_RX_FOD_GAIN_OFFSET0	0
	#define BIT_RX_FOD_GAIN_OFFSET1	8
	#define BIT_RX_FOD_GAIN_OFFSET2	16
	#define BIT_RX_FOD_GAIN_OFFSET3	24
	#define BIT_RX_FOD_GAIN_OFFSET4	32
	#define BIT_RX_FOD_GAIN_OFFSET5	40
#define I2CREG_RX_FOD_OFFSET	 0x00C1 	// Len = 6
	#define BIT_RX_FOD_OFFSET0	0
	#define BIT_RX_FOD_OFFSET1	8
	#define BIT_RX_FOD_OFFSET2	16
	#define BIT_RX_FOD_OFFSET3	24
	#define BIT_RX_FOD_OFFSET4	32
	#define BIT_RX_FOD_OFFSET5	40
#define I2CREG_RX_RSER	 0x00C7 	// Len = 1
...
#define I2CREG_RX_RP_CTRL	 0x00D5 	// Len = 1
	#define BIT_RP24_MAX_PWR	0
	#define BIT_RX_RP_FMT	6
...
#define I2CREG_RX_DTS_RCVD	 0x00DC 	// Len = 4
	...
	/*0x00: ADC/end0x02: ADC/auth0x05: ADC/rst0x10: ADC/prop0x11: ADC/prop0x12: ADC/prop0x13: ADC/prop0x14: ADC/prop0x15: ADC/prop0x16: ADC/prop0x17: ADC/prop0x18: ADC/prop0x19: ADC/prop0x1a: ADC/prop0x1b: ADC/prop0x1c: ADC/prop0x1d: ADC/prop0x1e: ADC/prop0x1f: ADC/prop*/
#define I2CREG_ARC_AUTO_OFF_THRES	 0x00E0 	// Len = 2
#define I2CREG_SC_MAX_PWR	 0x00E2 	// Len = 1
	#define BIT_SC_RP24_MAX_PWR	0
#define I2CREG_MAX_PWR_SWICH	 0x00E3 	// Len = 1
	#define BIT_MAX_PWR_SW	0
	/*0x0: rp24 0x1: sc rp24*/
#define I2CREG_RX_EPP_FOD_CUR_THRES	 0x00E4 	// Len = 5
	#define BIT_RX_EPP_FOD_CUR_THRES1	0
	#define BIT_RX_EPP_FOD_CUR_THRES2	8
	#define BIT_RX_EPP_FOD_CUR_THRES3	16
	#define BIT_RX_EPP_FOD_CUR_THRES4	24
	#define BIT_RX_EPP_FOD_CUR_THRES5	32
#define I2CREG_RX_EPP_FOD_GAIN	 0x00E9 	// Len = 6
	#define BIT_RX_EPP_FOD_GAIN_OFFSET0	0
	#define BIT_RX_EPP_FOD_GAIN_OFFSET1	8
	#define BIT_RX_EPP_FOD_GAIN_OFFSET2	16
	#define BIT_RX_EPP_FOD_GAIN_OFFSET3	24
	#define BIT_RX_EPP_FOD_GAIN_OFFSET4	32
	#define BIT_RX_EPP_FOD_GAIN_OFFSET5	40
#define I2CREG_RX_EPP_FOD_OFFSET	 0x00EF 	// Len = 6
	#define BIT_RX_EPP_FOD_OFFSET0	0
	#define BIT_RX_EPP_FOD_OFFSET1	8
	#define BIT_RX_EPP_FOD_OFFSET2	16
	#define BIT_RX_EPP_FOD_OFFSET3	24
	#define BIT_RX_EPP_FOD_OFFSET4	32
	#define BIT_RX_EPP_FOD_OFFSET5	40
#define I2CREG_RX_EPP_RSER	 0x00F5 	// Len = 1
#define I2CREG_TX_INTR_EN	 0x0100 	// Len = 4
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_SEND_PKT_SUCCESS_INTR_EN	6
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_EXT_MON_INTR_EN	7
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_CEP_TO_INTR_EN	8
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_RPP_TO_INTR_EN	9
	/*0x0: Disabled0x1: Enabled*/
	...
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_SEND_SUCCESS_INTR_EN	16
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_INTR_EN	17
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_SEND_END_RESET_INTR_EN	18
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_FOD_DET_INTR_EN	19
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_RCVD_SUCCESS_INTR_EN	20
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_INTR_EN	21
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_DTS_RCVD_END_RESET_INTR_EN	22
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_PTC_UPDATE_INT_EN	23
	/*0x0: Disabled0x1: Enabled*/
	#define BIT_TX_BRIDGE_MD_INTR_EN	24
	/*0x0: Disabled0x1: Enabled*/
#define I2CREG_TX_INTR_CLR	 0x0104 	// Len = 4
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_SEND_PKT_SUCCESS_INTR_CLR	6
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_EXT_MON_INTR_CLR	7
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_CEP_TO_INTR_CLR	8
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_RPP_TO_INTR_CLR	9
	/*0x0: No change0x1: Will be cleared*/
	...
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_SEND_SUCCESS_INTR_CLR	16
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_INTR_CLR	17
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_SEND_END_RESET_INTR_CLR	18
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_FOD_DET_INTR_CLR	19
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_RCVD_SUCCESS_INTR_CLR	20
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_INTR_CLR	21
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_DTS_RCVD_END_RESET_INTR_CLR	22
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_PTC_UPDATE_INT_CLR	23
	/*0x0: No change0x1: Will be cleared*/
	#define BIT_TX_BRIDGE_MD_INTR_CLR	24
	/*0x0: No change0x1: Will be cleared*/
#define I2CREG_TX_INTR_LATCH	 0x0108 	// Len = 4
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_SEND_PKT_SUCCESS_INTR_LATCH	6
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_EXT_MON_INTR_LATCH	7
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_CEP_TO_INTR_LATCH	8
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_RPP_TO_INTR_LATCH	9
	/*0x0: Did not occur0x1: Occurred*/
	...
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_SEND_SUCCESS_INTR_LATCH	16
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_INTR_LATCH	17
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_SEND_END_RESET_INTR_LATCH	18
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_FOD_DET_INTR_LATCH	19
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_RCVD_SUCCESS_INTR_LATCH	20
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_INTR_LATCH	21
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_DTS_RCVD_END_RESET_INTR_LATCH	22
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_PTC_UPDATE_INT_LATCH	23
	/*0x0: Did not occur0x1: Occurred*/
	#define BIT_TX_BRIDGE_MD_INTR_LATCH	24
	/*0x0: Did not occur0x1: Occurred*/
#define I2CREG_TX_STAT	 0x010C 	// Len = 4
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_SEND_PKT_SUCCESS_STAT	6
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_EXT_MON_INTR_STAT	7
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_CEP_TO_INTR_STAT	8
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_RPP_TO_INTR_STAT	9
	/*0x0: Is not occuring0x1: Occurring*/
	...
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_SEND_SUCCESS_STAT	16
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_SEND_END_TIMEOUT_STAT	17
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_SEND_END_RESET_STAT	18
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_FOD_DET_INTR_STAT	19
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_RCVD_SUCCESS_STAT	20
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_RCVD_END_TIMEOUT_STAT	21
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_DTS_RCVD_END_RESET_STAT	22
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_PTC_UPDATE_INT_STAT	23
	/*0x0: Is not occuring0x1: Occurring*/
	#define BIT_TX_BRIDGE_MD_INTR_STAT	24
	/*0x0: Is not occuring0x1: Occurring*/
#define I2CREG_TX_CMD	 0x0110 	// Len = 2
	#define BIT_TX_EN	0
	/*0x0: Do nothing0x1: Perform action*/
	#define BIT_TX_DIS	1
	/*0x0: Do nothing0x1: Perform action*/
	#define BIT_TX_SEND_MSG	2
	/*0x0: Do nothing0x1: Perform action*/
	#define BIT_TX_MEAS_Q	3
	/*0x0: Do nothing0x1: Perform action*/
	#define BIT_TX_SEND_DTS	4
	/*0x0: Do nothing0x1: Perform action*/
#define I2CREG_TX_EPT_REASON_RCVD	 0x0112 	// Len = 3
	...
	/*0x0: Did not appear0x1: Appeared*/
	#define BIT_TX_EPT_SRC_CEP_TO	6
	/*0x0: Did not appear0x1: Appeared*/
	#define BIT_TX_EPT_SRC_RPP_TO	7
	/*0x0: Did not appear0x1: Appeared*/
	...
	/*0x0: Did not appear0x1: Appeared*/
#define I2CREG_TX_RECENT_CEP	 0x0115 	// Len = 1
#define I2CREG_TX_VRECT	 0x0116 	// Len = 2
#define I2CREG_TX_VIN	 0x0118 	// Len = 2
#define I2CREG_TX_IOUT	 0x011A 	// Len = 2
#define I2CREG_TX_CHIP_TEMP	 0x011C 	// Len = 2
#define I2CREG_TX_OP_FREQ	 0x011E 	// Len = 2
#define I2CREG_TX_NTC	 0x0120 	// Len = 2
#define I2CREG_TX_DFT	 0x0122 	// Len = 4
	#define BIT_TX_DFT1	0
	/*ADC DFT1 ADC code*/
	#define BIT_TX_DFT2	16
	/*ADC DFT2 ADC code*/
#define I2CREG_TX_ADC_IN	 0x0126 	// Len = 2
	#define BIT_TX_ADC_IN3	0
	/*ADC IN3 ADC code*/
#define I2CREG_TX_PWR_TFRD_TO_RX	 0x0128 	// Len = 2
#define I2CREG_TX_PWR_RCVD_BY_RX	 0x012A 	// Len = 2
#define I2CREG_TX_OP_DC	 0x012C 	// Len = 1
#define I2CREG_TX_PTC	 0x012D 	// Len = 7
	#define BIT_TX_GUA_PWR	0
	#define BIT_TX_FSK_DEPTH	6
	/*0x0: -282~-249 / 30.25~63.250x1: -157~-124 / 61.5~94.50x2: -94.5~-61.5 / 124~1570x3: -63.25~-30.25 / 249~282*/
	#define BIT_TX_RPR_HDR	8
	/*0x31: RP24 format0x04: RP8 format*/
	#define BIT_TX_PCH	16
	#define BIT_TX_REF_PWR	24
	#define BIT_TX_OB	30
	/*0x0: not supported0x1: supported*/
	#define BIT_TX_AI	31
	/*0x0: not supported0x1: supported*/
	#define BIT_TX_REPING_DELAY	32
	#define BIT_TX_FSK_POLARITY	38
	/*0x0: Positive0x1: Negative*/
	#define BIT_TX_NEG	39
	/*0x0: BPP0x1: EPP*/
	#define BIT_TX_WIN_OFFSET	40
	#define BIT_TX_WIN_SZ	43
	#define BIT_TX_DUP	48
	/*0x0: not supported0x1: supported*/
	#define BIT_TX_BUFF_SIZE	49
	/*0x0: 16 bytes0x1: 32 bytes0x2: 64 bytes0x3: 128 bytes0x4: 256 bytes0x5: 512 bytes0x6: 1024 bytes0x7: 2048 bytes*/
	#define BIT_TX_MINOR_VER	52
#define I2CREG_TX_CTRL	 0x0134 	// Len = 1
	#define BIT_TX_BRIDGE_MD	0
	/*0x0: No change (same as ping)0x1: Manual half bridge mode0x2: Manual full bridge mode0x3: Auto switch*/
	#define BIT_TX_PING_HALF_BRIDGE	2
	/*0x0:Disable (Full bridge)0x1:Enable (Half bridge)*/
#define I2CREG_TX_BRIDGE_MODE_CUR_THRES	 0x0135 	// Len = 1
#define I2CREG_TX_BRIDGE_STAT	 0x0136 	// Len = 1
	#define BIT_TX_HALF_BRIDGE_STAT	0
	/*0x0: Full bridge0x1: Half bridge*/
#define I2CREG_TX_OVP_THRES	 0x0140 	// Len = 1
#define I2CREG_TX_OCP_THRES	 0x0141 	// Len = 1
#define I2CREG_TX_OVTP_THRES	 0x0142 	// Len = 1
#define I2CREG_TX_PID_MAX_CUR	 0x0143 	// Len = 1
#define I2CREG_TX_MAX_FREQ	 0x0144 	// Len = 1
#define I2CREG_TX_MIN_FREQ	 0x0145 	// Len = 1
#define I2CREG_TX_PING_FREQ	 0x0146 	// Len = 1
#define I2CREG_TX_PING_INTERVAL	 0x0147 	// Len = 1
#define I2CREG_TX_MAX_DC	 0x0148 	// Len = 1
#define I2CREG_TX_MIN_DC	 0x0149 	// Len = 1
#define I2CREG_TX_FOD_PLOSS_THRES	 0x014A 	// Len = 1
#define I2CREG_TX_FOD_DBNC_CNT	 0x014B 	// Len = 1
#define I2CREG_TX_CE_TO_MAX_CNT	 0x014C 	// Len = 1
#define I2CREG_TX_FHOP_STEP	 0x014D 	// Len = 1
#define I2CREG_TX_PING_DC	 0x014E 	// Len = 1
#define I2CREG_TX_DTS_SEND	 0x0150 	// Len = 4
	#define BIT_TX_DTS_ADC_SEND_LEN	0
	#define BIT_TX_DTS_ADC_SEND_REQUEST	16
	/*0x00: ADC/end0x02: ADC/auth0x05: ADC/rst0x10: ADC/prop0x11: ADC/prop0x12: ADC/prop0x13: ADC/prop0x14: ADC/prop0x15: ADC/prop0x16: ADC/prop0x17: ADC/prop0x18: ADC/prop0x19: ADC/prop0x1a: ADC/prop0x1b: ADC/prop0x1c: ADC/prop0x1d: ADC/prop0x1e: ADC/prop0x1f: ADC/prop*/
#define I2CREG_TX_DTS_RCVD	 0x0154 	// Len = 4
	#define BIT_TX_DTS_ADC_RCVD_LEN	0
	#define BIT_TX_DTS_ADC_RCVD_REQUEST	16
	/*0x00: ADC/end0x02: ADC/auth0x05: ADC/rst0x10: ADC/prop0x11: ADC/prop0x12: ADC/prop0x13: ADC/prop0x14: ADC/prop0x15: ADC/prop0x16: ADC/prop0x17: ADC/prop0x18: ADC/prop0x19: ADC/prop0x1a: ADC/prop0x1b: ADC/prop0x1c: ADC/prop0x1d: ADC/prop0x1e: ADC/prop0x1f: ADC/prop*/
#define I2CREG_Q_EXCITE_FREQ	 0x015A 	// Len = 1
#define I2CREG_Q_MEAS_RESONANT_FREQ	 0x015C 	// Len = 2
#define I2CREG_Q_MEAS_QFACTOR	 0x015E 	// Len = 2
#define I2CREG_Q_MEAS_ADC	 0x0160 	// Len = 2
